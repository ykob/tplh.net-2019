...
<template lang="pug">
.p-whoiam-content
  .p-whoiam-content__section.p-whoiam-content__section--1
    h2
      |I'm a Web Developer.
      br
  ...
  .p-whoiam-content__section.p-whoiam-content__section--2
    h2
  ...
  .p-whoiam-content__section.p-whoiam-content__section--3
    p
